...
let question1 = input.questionInt("Let's pick a random index and find it shall we?! Starting at 0, pick a number 0 through " + [response.length-1] + "! "); // Asks user to pick a number between 0 and the number of character in the word they chose
...
console.log("Thanks for participating! Now I'm gonna go and... I dunno process something I guess. K thanks, Bye!");